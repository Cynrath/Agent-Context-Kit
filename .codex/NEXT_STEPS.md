...
TASK-0051 through TASK-0054 alpha.2 hardening task set is created and active.
...
9. Treat TASK-0053 Turkish localization polish as implemented locally; commit after validation if not committed.
...
12. Do not push, create GitHub releases, publish NuGet packages, redact, delete, force push, or create remotes from the agent session.
13. Keep the legacy v1.0 readiness reference available: `TASK-0039` and `scripts/check-v100-readiness.ps1`.
