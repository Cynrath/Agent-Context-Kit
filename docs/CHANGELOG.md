# Documentation Planning Changelog
...
- Added the agent context pipeline taxonomy and authoritative no-network default policy.
- Added the external-tool privacy threat model and disposable lab plan.
- Added maintainer blocker board and decision register.
- Refreshed `v0.2.0-alpha.2` planning without changing version or release state.
