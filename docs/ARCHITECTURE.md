...
These SARIF, rule catalog, and config allowlist capabilities are part of current source and the published `0.2.0-alpha.2` package. The published NuGet `0.1.0-alpha.2` package remains the previous public release.
