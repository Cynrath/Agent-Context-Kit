...
| 29 | Next | TASK-0094 English/Turkish localization parity release gate | High | V100-10 remains open | CLI/tests/docs/scripts | Full localized contract matrix | No | Help, diagnostics, errors, and JSON invariance are release-gated. |
