...
| 25 | Next | TASK-0090 hosted baseline upgrade and performance workflow design | High | Hosted execution requires maintainer push | workflow/docs/scripts | Local syntax/gates plus hosted run | Yes, to push/run hosted workflows | Cross-platform RC evidence is designed without automatic remote writes. |
