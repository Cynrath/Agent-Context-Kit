...
| V100-06 | P0 | Security response process still lacks verified private disclosure activation. | Response expectations, Critical regression coverage, dated dependency review, and TASK-0095 metadata-only evidence/handoff are complete locally. | Security + Maintainer | Enable and verify private GitHub vulnerability reporting; record date, owner, and non-sensitive evidence reference. | Yes | Yes, for hosted security settings/contact |
