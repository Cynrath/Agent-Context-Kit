...
| --- | --- | --- | --- | --- | --- | --- | --- |
| V100-01 | P0 | Baseline-aware CI policy is not implemented. | TASK-0082 selects the design direction only. | Core + CLI | Sanitized versioned baseline model, deterministic cross-platform fingerprints, explicit update flow, new-versus-existing tests, Critical safety tests. | Yes | No |
