...
| V100-04 | P0 | JSON and SARIF contracts lack published machine-readable schema/version migration assets. | JSON schema `2`, baseline schema `1`, SARIF `2.1.0`, additive contract tests, and TASK-0092 conditional rules are documented. | Core + CLI | Add versioned schema/golden contract assets, migration notes, and enforcement for additive/breaking rules. | Yes | No |
